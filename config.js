...
//var globalAccountSettings=[{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/master/', hrefLabel: 'Master Informatique : Calendriers', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []}];
//var globalAccountSettings=[{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/DAC/', hrefLabel: 'Master Informatique : Calendriers', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []}];
/*
	scp -p ~/Sites/FichiersConfiguration/cal.ufr-info-p6.jussieu.fr/caldavzap_master/config.js root@cal.ufr-info-p6.jussieu.fr:/usr/share/davical/master/.
	ssh root@cal.ufr-info-p6.jussieu.fr
	cd /usr/share/davical/master; ./cache_update.sh
	Attention que le premier settingsAccount: true pour enregistrer les modifications de présentation d'Agenda
*/

var globalAccountSettings=[];
var names_to_click=[];
//On récupère les parcours et catégories souhaités
function magic_master_filter()
{
	...
	let possibilities = [
		...
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/DAC/', hrefLabel: 'Master DAC', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/IMA/', hrefLabel: 'Master IMA', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/RES/', hrefLabel: 'Master RES', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/SAR/', hrefLabel: 'Master SAR', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/SESI/', hrefLabel: 'Master SESI', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/SFPN/', hrefLabel: 'Master SFPN', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
		{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/STL/', hrefLabel: 'Master STL', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
	]
	...
	blocks.forEach(function(e){
		...
		for(var i=0; i<possibilities.length; i++){
			if(possibilities[i].href.includes(n))
			{
				globalAccountSettings.push(possibilities[i])
				possibilities.splice(i,1)
				i--;
			}
		}
		for(var i=1; i<sb.length; i++){
			names_to_click.push("/"+sb[i].toUpperCase()+"/");
		}
	})
}
...
/*var globalAccountSettings=[
	{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/MasterInfo/', hrefLabel: 'Informatique (Master)', forceReadOnly: true, settingsAccount: true, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
	{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/IMA/', hrefLabel: 'Master IMA', forceReadOnly: true, settingsAccount: false, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
];*/
...
var globalSubscribedCalendars={hrefLabel: 'Informatique (Master)', calendars: [
	{displayName: 'M2', href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/MasterInfo/M2/', userAuth: {userName: 'student.master', userPassword: 'guest'}, ignoreAlarm: true, color: '#ff0000', typeList: ['vevent','vtodo']}
]};
/*
{href: 'https://cal.ufr-info-p6.jussieu.fr:443/caldav.php/MasterInfo/', hrefLabel: 'Informatique (Master)', forceReadOnly: true, settingsAccount: true, checkContentType: true, userAuth: {userName: 'student.master', userPassword: 'guest'}, timeOut: 90000, lockTimeOut: 10000, delegation: false, ignoreAlarms: true, backgroundCalendars: []},
*/
...
var globalInterfaceCustomLanguages=['fr_FR'];
...
var globalNewVersionNotifyUsers=['admin'];
...
// note: settings stored on server (see settingsAccount) overwrites this variable
var globalActiveCalendarCollections=['M2'];
...
var globalCalendarStartOfBusiness=8.5;
